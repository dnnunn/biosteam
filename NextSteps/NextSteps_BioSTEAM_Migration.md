...
- **DSP03 Post-capture conditioning** – Single UF→DF→UF baseline (30 kDa PES): VRR≈3×, ND=5, flux≈85 LMH, TMP≤1.5 bar, adsorption ≈0.2%/100 m². Future work: add viscosity/TMP estimation to proactively derate area and apply antifoam penalties automatically.
